...
@Component({
  selector: 'app-trainer-it',
  standalone: true,
  imports: [CommonModule,FormsModule,RouterModule],
  templateUrl: './trainer-it.component.html',
  styleUrl: './trainer-it.component.css'
})
export class TrainerItComponent {
  // Array of IT training modules (for example)
  trainingModules = [
    { name: 'Web Developer', fileUrl: '' },
    { name: 'AI/ML Engineer', fileUrl: '' },
    { name: 'Cloud Engineer', fileUrl: '' }
  ];
